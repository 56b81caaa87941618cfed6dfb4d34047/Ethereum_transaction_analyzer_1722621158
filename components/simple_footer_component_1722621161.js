...
*/
Vue.component("simple_footer_component_1722621161", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the game with real-time monitoring and analysis of new Ethereum transactions. EtherScan provides comprehensive insights into the latest activity on the Ethereum blockchain.
                    </div>
                </div>
            </div>
        </footer> 
